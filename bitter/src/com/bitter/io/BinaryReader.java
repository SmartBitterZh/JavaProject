...
public class BinaryReader extends FilterInputStream {
	...
	protected BinaryReader(InputStream in) {
		super(in);
	...
	/**
	 * Source:
	 * https://github.com/vrecan/Thaw-Giant/blob/master/src/main/java/com
	 * /vreco/thawgiant/BinaryUtil.java Binary files are encoded with a variable
	 * length prefix that tells you the size of the string. The prefix is
	 * encoded in a 7bit format where the 8th bit tells you if you should
	 * continue. If the 8th bit is set it means you need to read the next byte.
	 * 
	 * @param bytes
	 * @return
	 * @throws IOException
